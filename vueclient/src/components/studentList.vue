<template>
  <div class="adminList main">
    <div class="input_box">
      <input v-model="Admin.name" class="myinput" type="text" placeholder="旅客名" />
      <input v-model="Admin.phone" class="myinput" type="text" placeholder="线路名" />
      <input v-if="!editAdminObj" v-model="Admin.password" class="myinput" type="password" placeholder="时间" />
